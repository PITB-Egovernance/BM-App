...
const Step4toAppointment = ({route,navigation,visible, onClose}) => {
  ...
  useEffect(() =>{
    ...
    getProvince();
    const pwdinfoDetail     = route.params.pwdinfo;
  ...
  const handleAppointmentForm = () =>{
    ...
    .then(responseAppointment => {
      ...
      responseAppointment.appointment.id !='' 
      ?
      syncStorage.set('pwdAppointmentID',responseAppointment.appointment.id)
      :responseAppointment
...
export default Step4toAppointment;